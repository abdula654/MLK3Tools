...
SETTINGS_GROUPS: List[SettingGroup] = [
    SettingGroup(
        key="general",
        label="General",
        description="Global MLK3Tools preferences.",
        options=[
            SettingOption(
                key="useSteamLanguage",
                label="Use Steam Language",
                option_type="toggle",
                description="Use the Steam client's language for MLK3Tools.",
                default=True,
            ...
            SettingOption(
                ...
                label="Language",
                option_type="select",
                description="Choose the language used by MLK3Tools.",
                default="en",
            ...
            SettingOption(
                ...
                label="Donate Keys",
                option_type="toggle",
                description="Allow MLK3Tools to donate spare Steam keys. (placeholder option)",
                default=True,
                metadata={"yesLabel": "Yes", "noLabel": "No"},
            ),
            SettingOption(
                ...
                label="Theme",
                option_type="select",
                description="Choose the color theme for MLK3Tools interface.",
                default="original",
